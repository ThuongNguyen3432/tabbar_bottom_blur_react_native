...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  // Without this the URL scheme is registered but never reaches JavaScript:
  // iOS hands the link to the app delegate, and RCTLinkingManager is what
  // forwards it to React Native's Linking module.
  func application(
    _ app: UIApplication,
    open url: URL,
  ...
  // Universal links (https://), as opposed to the custom scheme above.
  func application(
    _ application: UIApplication,
